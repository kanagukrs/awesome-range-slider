describe('awesomeRangeSlider', function () {
  var testDirective,
  noop = angular.noop,
  scope,
  ...
  beforeEach(module('awesomeRangeSlider'));
  ...
  describe('slider directive', function () {
    it('horizontal ', function () {
      testDirective('<input ng-model="value" type="text" id="mySlider1" awesome-range-slider options="options" />', scope.value);
    });

    it('simple', function () {
      testDirective('<input ng-model="value2" type="text" id="mySlider2" awesome-range-slider options="options" />', scope.value2);
    });

    it('simple', function () {
      testDirective('<input ng-model="value3" type="text" id="mySlider3" awesome-range-slider options="options" />', scope.value3);
    });    
  });
