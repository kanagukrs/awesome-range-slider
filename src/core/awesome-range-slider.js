(function (angular) {
  ...
  angular.module('awesomeRangeSlider', [])
    // DIRECTIVE
    .directive('awesomeRangeSlider', [
      ...
      function(compile, templateCache, timeout, win, Slider) {
        return {
          ...
          // compile template
          element.after(compile(templateCache.get('awesome-range-slider/slider-bar.tmpl.html'))(scope, function(clonedElement, scope) {          
